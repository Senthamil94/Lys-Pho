/**
 * Ly's Phở — Accessibility Tools Widget
...
(function () {
  ...
  function applyTextScale() {
    ...
    root.dataset.a11yTextScale = String(state.textScale);

    /* Ly's Pho uses px font sizes, so root font-size alone does not scale text.
